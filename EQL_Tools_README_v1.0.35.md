...
1. Put `EQL_Tools_v1.0.35.exe` anywhere you can write to. Your Documents
...
Both carry the same layout. A **Solo / Group** switch sits at the top: solo
...
**1.0.35.** The version history is in the app under Advanced Features →
