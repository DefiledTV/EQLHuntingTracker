[README.md](https://github.com/user-attachments/files/29985949/README.md)
# EQL Hunting Log
...
2. Download `eql_tracker_app_v0.2.1.pyw` (or run the installer from Releases).
...
python -m PyInstaller --onefile --noconsole eql_tracker_app_v0.2.1.pyw
```

See `INSTALLATION.md` for all setup methods, and `eql_changelog_v0.2.1.md` for full version history.
